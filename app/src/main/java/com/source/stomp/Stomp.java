...
import com.source.stomp.provider.OkHttpConnectionProvider;
import com.source.stomp.provider.WebSocketsConnectionProvider;
...
public class Stomp {
    ...
    private static StompClient createStompClient(com.source.stomp.provider.ConnectionProvider connectionProvider) {
